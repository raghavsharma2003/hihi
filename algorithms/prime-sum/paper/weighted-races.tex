...
content. Comments are very welcome.}}
\date{August 2026}
...
densities for any weighted prime race, computed across the delicate
range under the standard GRH + LI hypotheses --- e.g.\ for modulus $4$,
$\delta(1)=0.79731(20)$, $\delta(2)=0.69468(23)$,
$\delta(3)=0.64577(24)$, with the calibration $\delta(0)=0.99593(3)$
recovering the classical Rubinstein--Sarnak value; (ii) the
...
$\sim3\times10^{-3}$; (iii) an asymptotic dissolution law in the weight
...
addressing Problem 12 of the comparative prime number theory problem
list of Hamieh, Kadiri, Martin and Ng computationally.
\end{abstract}
...
$p^{-s}$ with $s<\tfrac12$ sign changes persist~\cite{SK25}. Humphries
...
to our knowledge, the first Rubinstein--Sarnak densities computed for
any weighted prime race.
...
$m$ & $0$ & $1$ & $2$ & $3$ & $8$ & $20$ & $100$\\
\midrule
$\delta_4(m)$ & $0.99593$ & $0.79731$ & $0.69468$ & $0.64577$
& $0.57216$ & $0.53821$ & $0.51370$\\
$\delta_3(m)$ & $0.99904$ & $0.83679$ & $0.72361$ & $0.66695$
& $0.57879$ & $0.54094$ & --- \\
\bottomrule
\end{tabular}
\caption{Logarithmic densities of the set where the nonresidue class
leads, moduli $4$ and $3$ (Monte Carlo standard errors
$\le3.5\times10^{-4}$; $511$ resp.\ $537$ zeros computed to $25$
digits, Gaussian tail from the zero-counting density). The $m=0$
column reproduces the classical values $0.9959$ and $0.9990$
\cite{RS94}.}
\label{tab:delta}
\end{table}
...
$0.64900$ for $m=1,2,3$, within $\sim3\times10^{-3}$ of
...
At $q=4$, $m=100$: Monte Carlo $0.51370(35)$, Gaussian $\Phi(1/\sigma)$
$0.51379$, the law $0.51380$. At $q=3$, $m=60$: variance law within
$0.26\%$ of Monte Carlo. The modulus ordering
...
Languasco--Zaccagnini~\cite{LZ10} (cf.\ OEIS A368645/A086239) to all
compared digits. Notably, none of the races $m\in\{-1,-\tfrac34,
-\tfrac12\}$ changes sign even once on $[3,10^{10}]$ (minimum margin
$2/15$ at $x=5$): in this range of weights Chebyshev's bias is not
...
below $10^{10}$) reproduce the classical values. The explicit-formula
...
exact to $10^9$ at $m=1$), available with all code and data in the
accompanying repository. Every headline number in this note was
...
\bibitem{HKMN24} A. Hamieh, H. Kadiri, G. Martin, N. Ng (eds.),
\emph{Comparative prime number theory: a survey with open problems},
arXiv:2407.03530 (2024), Problem 12.
