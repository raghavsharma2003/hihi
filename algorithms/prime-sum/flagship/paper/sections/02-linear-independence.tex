...
\tag{3.1}\label{eq:reciprocal-frob-polynomial}
\]
...
\[
 ...
 \in\mathbb Q[X].
\tag{3.2}\label{eq:normalized-rational-polynomial}
\]
...
\tag{3.3}\label{eq:angle-multiplicative-relation}
\]
...
\tag{3.6}\label{eq:LI-growth-condition}
\]
...
\tag{3.8}\label{eq:explicit-field-growth}
\]
