...
\begin{align}
 ...
 \label{eq:exact-prime-decomposition}\\
 R_2(N)
...
\label{eq:unramified-square-count}
\end{equation}
...
\begin{equation}
 \ell+am\ell-MN.
\label{eq:higher-power-exponent}
\end{equation}
...
\begin{equation}
 ...
 \right).
\label{eq:finite-density-functional}
\end{equation}
\end{proposition}
...
\label{eq:critical-amplitude-limit}
\end{equation}
